...
def extract_votable(catalogue: str, out_max: int = 10000):
    ...
    :param out_max: max number of objects
    """
    ...
    for line in proc.stdout:
        ...
        record = [float(value.strip()) for value in re.split(r" +", line)]
...
if __name__ == '__main__':
    print(extract_votable('/II/7A/catalog/', 10))
